function [result10,result9,ff_2,ff_3,ff_4] = Fillingnew_malihe( RESRES,fluorangio)
clc
...
ff_2=ff3(:,:,2);ff_3=ff3(:,:,3);ff_4=ff3(:,:,4);
...
for i=2:size(RESRES,1)-1
    for j=2:size(RESRES,2)-1
