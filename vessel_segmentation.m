...
COEF0 = fdct_wrapping(II,1,1);%fdct_wrapping(img11,1,1);
...
global Gxx Gxy Gyy Gx Gy beta gama G
 ...
 for ii=1:size(COEF0{2},2)/2
   ...
   I_0(:,:,ii) = ifdct_wrapping(E0,1,256,256);%figure,imagesc(I_0) 
...
[vessel_long,vessel_thin,RESfinal5] = valadation_direct( AS1,f,QP,img_direct1,se_siz7);
