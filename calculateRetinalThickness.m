%
function calculateRetinalThickness(imagePath)
%     {{Caserel}}
...
% filename = 'D:\kafieh\AMPAO\imi1.tiff_octSegmentation.mat';
% filename = strcat(handles.PathName,handles.FileName(1:end-4),num2str(scan_num(1)),'.tiff_octSegmentation.mat')
...
choice = questdlg('Would you like to calculate thicknesses?');
