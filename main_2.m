...
fluorangio1 = (imread(bmpin));
%%%%color
 fluorangio=fluorangio1(:,:,2);
...
save 'D:\mydata\oct-mokhtary\mokhtari\data_oct\OD-mat\v1084lf.mat'  Vessels_oct 
% imwrite(Vessels_oct,('C:\mydata\oct-mokhtary\mokhtari\DATA_funduD:\mydata\oct-mokhtary\mokhtari\data base\3s1\685 dr.gif')));